...
const JOURNEYS = [
  ...
  {
    key: 'middle-earth-west-road',
    name: 'The West Road',
    world: 'middle-earth',
    subtitle: 'Green hills to the last watchtower · 32 km',
    description: 'A fellowship-style road across quiet hill country, old stone markers, a river crossing, and a final climb to a watchtower above the eastern plain.',
    scripture_ref: 'Psalm 121:8',
    total_km: 32,
    terrain: 'rolling',
    elevation_m: 520,
    activity_hint: 'run',
    waypoints: [
      { km_mark: 0, title: 'The Green Gate', scripture_ref: 'Psalm 121:8', narrative: 'The road leaves a warm valley behind and threads between hedges silvered with morning. You travel light, with a long way still to go.' },
      { km_mark: 8, title: 'The Old Stone Mile', scripture_ref: 'Proverbs 4:26', narrative: 'A weathered marker stands where three paths meet. The road east is the least certain, which is usually how you know it is yours.' },
      { km_mark: 16, title: 'The Grey River', scripture_ref: 'Isaiah 43:2', narrative: 'The water is cold and quick over pale stones. You cross carefully, then look back once before the far bank hides the country you came from.' },
      { km_mark: 24, title: 'The Watch Fires', scripture_ref: 'Matthew 5:14', narrative: 'Small beacons mark the ridgeline ahead. None are lit, but each one says that someone expected travellers to need a light.' },
      { km_mark: 32, title: 'The High Watchtower', scripture_ref: 'Psalm 18:33', narrative: 'The final climb opens onto a wide view: green country behind, blue distance ahead, and the satisfying knowledge that the road was made one step at a time.' },
    ],
  },
  {
    key: 'narnia-lantern-wood',
    name: 'The Lantern Wood',
    world: 'narnia',
    subtitle: 'A snowy forest road to the stone table · 21 km',
    description: 'A winter route through silver birches and deep snow, guided by a single lantern and the promise that thaw can arrive all at once.',
    scripture_ref: 'Isaiah 9:2',
    total_km: 21,
    terrain: 'rolling',
    elevation_m: 300,
    activity_hint: 'walk',
    waypoints: [
      { km_mark: 0, title: 'The Wardrobe Gate', scripture_ref: 'Isaiah 9:2', narrative: 'Cold air, quiet branches, and snow that looks untouched except for one narrow trail leading between the trees.' },
      { km_mark: 5, title: 'The Lantern', scripture_ref: 'John 1:5', narrative: 'A golden lantern burns where no road should be. You stop long enough to warm your hands, then follow the light deeper into the wood.' },
      { km_mark: 11, title: 'The Frozen River', scripture_ref: 'Psalm 147:16', narrative: 'The river is sealed beneath blue ice. The crossing is sound, but you still test every step and listen to the enormous silence.' },
      { km_mark: 16, title: 'The Stone Table', scripture_ref: 'Psalm 23:5', narrative: 'A broad table of pale stone stands in a clearing, ringed by firs. The wind has changed, and the snow has begun to soften.' },
      { km_mark: 21, title: 'The First Thaw', scripture_ref: 'Isaiah 43:19', narrative: 'Water runs beneath the snow and birds return to the branches. Twenty-one kilometres later, the forest feels less like a test and more like a welcome.' },
    ],
  },
];
